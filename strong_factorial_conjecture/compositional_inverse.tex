...
\begin{proof}
    \begin{align}
        ...
        &= [X^n] \sum_{k \geq 0} \binom{n+k}{n} \sum_{k_1 + \cdots k_m = k} \frac{k!}{k_1! \cdots k_m!} (\alpha_1 X)^{k_1} \cdots (\alpha_m X^m)^{k_m} \\
        &= \frac{1}{n!} [X^n] \sum_{k \geq 0} (n + k)! \sum_{k_1 + \cdots k_m = k} \frac{1}{k_1! \cdots k_m!} \alpha_1^{k_1} \cdots \alpha_m^{k_m} X^{k_1 + \cdots m k_m} \\
        &= \frac{1}{n!} \sum_{k_1 + 2k_2 + \cdots + m k_m = n} \frac{(n + k_1 + \cdots + k_m)!}{k_1! \cdots k_m!} \alpha_1^{k_1} \cdots \alpha_m^{k_m}
    \end{align}
    \begin{enumerate}
        \item substituted \(f(X)\)
        \item see concrete mathematics 5.56
        \item multinomial theorem
        \item just reformulated
        \item extract the coefficient of \(X^n\) by setting \(k_1 + 2 k_2 + \cdots + m k_m = n\)
    \end{enumerate}
\end{proof}
\end{document}