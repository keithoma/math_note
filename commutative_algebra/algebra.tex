...
\begin{document}
\part{Topology}
\input{contents/topology.tex}
\part{Other Stuff}
\input{contents/other_stuff.tex}
\part{Commutative Rings}
\input{contents/rings.tex}
\input{contents/radicals.tex}
\input{contents/spec.tex}
\part{Modules}
\input{contents/exact_sequences.tex}
\input{contents/tensor_product.tex}
\input{contents/flatness.tex}
\end{document}