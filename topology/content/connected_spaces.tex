...
\end{defbox}
\begin{proof}
    We verify the equivalence of the different definitions. So, let \(X\) be a topological space.
    \begin{itemize}
...
% exercise
If \(X\) and \(Y\) are two connected topological spaces, then their product \(X \times Y\) is also connected.
\begin{proof}
