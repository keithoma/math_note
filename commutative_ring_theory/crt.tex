...
\begin{proof}
    ...
    \begin{enumerate}
        ...
        \item Since \(\sqrt{\sqrt{\mathfrak{a}}} \supset \sqrt{\mathfrak{a}}\) from above, it suffices to verify the other inclusion. Let \(x \in \sqrt{\sqrt{\mathfrak{a}}}\), then \(x^n \in \sqrt{\mathfrak{a}}\)
