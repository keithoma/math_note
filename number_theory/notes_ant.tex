...
\begin{thmbox}
    \begin{proposition}
        ...
        \begin{equation*}
            \chi_\alpha(X) = m_\alpha(X) h(X)
        \end{equation*}
        where \(\chi_\alpha\) is the characteristic polynomial of \(\alpha\), \(m_\alpha\) is the minimal polynomial of \(\alpha\), and \(h(X)\) is a polynomial in \(\mathbb{Q}[X]\).
    \end{proposition}
\end{thmbox}
\begin{proof}
