...
\begin{proof}
    \begin{enumerate}
        ...
        \end{align*}
        Thus \(1 + a_{n-1} X + \cdots + a_1 X^{n-1} \pm X^n\) is a polynomial in \(\mathbb{Z}[X]\) that has \(v\) as a root. This polynomial can be converted to a monic polynomial depending on the sign of the monomial of the highest degree. Therefore, \(u \in \mathcal{O}_K\).
    \end{enumerate}
\end{proof}


\subsection{Integral Basis and Discriminant}
