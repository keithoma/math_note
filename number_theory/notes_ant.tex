...
\begin{example}
    Let \(K = \mathbb{Q}(i)\), then \(\mathcal{O}_K = \mathbb{Z}[i]\). If \(\alpha = a + ib\) with \(a, b \in \mathbb{Q}\), then \(\mathrm{Tr}_K(\alpha) = 2a\) and \(\mathrm{N}_K(\alpha) = a^2 + b^2\).
\end{example}
\begin{proof}
...
\begin{example}
    Let \(K = \mathbb{Q}(\sqrt{2})\), then \(\mathcal{O}_K = \mathbb{Z}[\sqrt{2}]\). If \(\alpha = a + \sqrt{2}b\) with \(a, b \in \mathbb{Q}\), then \(\mathrm{Tr}_K(\alpha) = 2a\) and \(\mathrm{N}_K(\alpha) = a^2 - 2b^2\).
\end{example}
\begin{proof}
