...
\end{thmbox}
\begin{enumerate}
    \item \begin{proof} Let \(\alpha\) be an algebraic integer. Since the characteristic polynomial of \(\alpha\) is its the minimal polynomial, it has integer coeffcients. Moreover, we have \(N(\alpha) = (-1)^n \chi_\alpha(0) = (-1)^n a_0\) which again is an integer.
    \end{proof}
    \item \begin{proof}
